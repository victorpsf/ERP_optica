...
namespace Shared.Services
{
    public class JwtService
    {
        ...
        { return BinaryConverter.ToBytesView(this.Configuration.GetSection("Secret:Key").Value ?? "", BinaryConverter.StringView.HEXADECIMAL); }

        private int GetTotalMinutes()
        {
            try { return Convert.ToInt32(this.Configuration.GetSection("Token:Minutes").Value); }
            catch { return 60; }
        }
